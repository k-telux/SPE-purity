...
x_values = data[:, 0]
y_values = data[:, 1]
y_corrected=y_values-gaussian(x_values,2000, 1.505, 0.03)-gaussian(x_values,463,1.62775,0.0722)-gaussian(x_values,1500, 1.55, 0.03)-gaussian(x_values,2000, 1.54, 0.04)
plt.plot(x_values,y_corrected , label='Data')
#np.savetxt('corrected_data1.txt', np.column_stack((x_values, y_corrected)), delimiter=',', header='Energy (eV), Intensity (a.u.)', comments='')
...
# main peak
plot_lines(x_values, 'gaussian', 10000, 1.55355, 0.0007, 0, 0)
